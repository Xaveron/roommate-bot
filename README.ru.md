...
| Очередь | История | Баланс | Статистика |
|:---:|:---:|:---:|:---:|
| <img src="docs/screenshots/queue.png" width="200" alt="Очереди по категориям"> | <img src="docs/screenshots/history.png" width="200" alt="Таблица истории"> | <img src="docs/screenshots/balance.png" width="200" alt="Балансы и переводы"> | <img src="docs/screenshots/stats.png" width="200" alt="Статистика месяца с графиками"> |
...
- **Mini App** (`/app` или кнопка меню **📱 Приложение**). Там очереди, таблица истории, балансы
  и статистика с интерактивными графиками. Приложение подстраивается под светлую и тёмную тему
  Telegram и работает на ru, ro и en.
...
Фронтенд написан на React + Vite (`webapp/`). Бэкенд — небольшой FastAPI только для чтения
(`bot/webapi/`), он работает с той же базой и сервисами, что и бот. На сервере оба стоят за
Caddy, который даёт HTTPS с автоматическими сертификатами Let's Encrypt.
