...
- **Очередь по кругу.** У каждой категории своя очередь, и первым идёт тот, кто дольше всех
  не делал.
...
- **Настройки** (`/settings`, инлайн-кнопки): время и дни напоминаний для каждой категории,
  тихие часы, часовой пояс (по умолчанию `Europe/Chisinau`), язык.
...
- [ ] **Этап 2:** режим «fair», повторные напоминания, режим «я уехал», подтверждения
- [ ] **Этап 3:** траты и балансы, список покупок, статистика и графики, достижения,
